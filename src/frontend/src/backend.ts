...
export class Backend implements backendInterface {
    ...
    async addFavoriteMeal(arg0: FavoriteMeal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFavoriteMeal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFavoriteMeals(): Promise<Array<FavoriteMeal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFavoriteMeals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMealSuggestions(arg0: string, arg1: bigint): Promise<Array<MealSuggestion>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMealSuggestions(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNearbyPlaces(arg0: string): Promise<Array<Place>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNearbyPlaces(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSupportedRegions(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSupportedRegions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeFavoriteMeal(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFavoriteMeal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveProfile(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
